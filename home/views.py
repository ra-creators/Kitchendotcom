...
def kitchen_summary_buildpkg(request):
    ...
    pdf.cell(150,10,context['location'], ln=1, border="R", align="L", fill=1)
    ...
    pdf.cell(200,4,"5. Appliances are not counted in above quotaion i.e. it will be quoted as per selection ", ln=1, align="L")
    pdf.cell(200,4,"6. Ceiling light, Civil work,Plumbing and Flooring not included . ", ln=1, align="L")
    pdf.cell(200,4,"7. Payment terms will be ( 50% Advance + 20% + 20% + 10% before/on the day of site handover).", ln=1, align="L")
