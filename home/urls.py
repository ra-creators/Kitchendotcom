...
urlpatterns = [
    ...
    path("select_finish/laminate", views.select_finish_laminate, name='select_finish_laminate'),
    path("select_finish/pvclaminate", views.select_finish_pvclaminate, name='select_finish_pvclaminate'),
    path("select_finish/asacrylic", views.select_finish_asacrylic, name='select_finish_asacrylic'),
    path("select_finish/glossypu", views.select_finish_glossypu, name='select_finish_glossypu'),
    path("select_accessories", views.select_accessories, name='select_accessories'),
    path("select_accessories/basic", views.select_accessories_basic, name='select_accessories_basic'),
    path("select_accessories/intermediate", views.select_accessories_intermediate, name='select_accessories_intermediate'),
    path("select_accessories/premium", views.select_accessories_premium, name='select_accessories_premium'),
